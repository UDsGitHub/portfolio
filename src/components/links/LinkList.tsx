...
export default function LinkList() {
  ...
  return (
    <ul
      className={`flex justfiy-center items-center w-fit mx-auto mb-4 ${
        isAboveMediumScreens &&
        "fixed bottom-0 -left-10 flex-col gap-2 text-black py-6 mb-0 rounded-tr-md"
      }`}
    >
      <LinkListItem
      ...
      />
      <LinkListItem
        url="https://www.linkedin.com/in/udochukwu-amaefule/"
        icon={
          <svg
            xmlns="http://www.w3.org/2000/svg"
            role="img"
